...
/*
        ...
        @param velocity_prev_x - the velocity of a position in the x direction a
   moment ago
        @param velocity_y - the velocity of a position in the y direction
        @param velocity_prev_y - the velocity of a position in the y direction a
   moment ago
...
/*
        project
        makes sure no new liquid appear or disappear using Poisson equation and
